...
const SITUATIONS = [
  {
    ...
    title: 'Banco sospechoso', desc: 'Me piden datos o clave',
    color: '#ef4444', bg: 'rgba(239,68,68,.04)', border: 'rgba(239,68,68,.30)',
    tag: 'VISHING',
    msg: 'Me llamaron del banco y me pidieron mi clave',
  },
  {
    svg: `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>`,
  ...
  {
    svg: `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18" stroke-width="2.5"/></svg>`,
  ...
  {
    svg: `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16" stroke-width="2.5"/></svg>`,
    title: 'Caí en estafa', desc: '¿Qué hago ahora?',
    color: '#f97316', bg: 'rgba(249,115,22,.04)', border: 'rgba(249,115,22,.30)',
    tag: 'FRAUDE',
    msg: 'Creo que me estafaron, veo movimientos raros en mi cuenta',
  },
  {
    svg: `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>`,
    title: 'En la puerta', desc: 'Pide datos o dinero',
  ...
  {
    svg: `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>`,
    title: 'Maltrato', desc: 'Hablá, no estás solo/a',
    color: '#38bdf8', bg: 'rgba(56,189,248,.04)', border: 'rgba(56,189,248,.30)',
    tag: 'APOYO',
    msg: 'Sufrí violencia o maltrato y me siento vulnerable, ¿qué puedo hacer?',
  },
]
...
Gratis · Seguro · 24hs · No estás solo.
              ...
              <div className="relative flex items-center justify-between px-6 h-full">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '1.15rem', fontWeight: 900, color: '#000', lineHeight: 1.1 }}>Necesito ayuda ahora</div>
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '.78rem', fontWeight: 600, color: 'rgba(0,0,0,.65)', marginTop: -1 }}>Hablá con nuestro asistente</div>
                  </div>
                </div>
          ...
          <div className="relative w-full mb-2.5">
            <motion.button
              ...
              <div className="relative flex items-center justify-between px-6 h-full">
                <div className="flex items-center gap-4">
                  <motion.div animate={{ scale:[1,1.18,1] }} transition={{ duration:1.8, repeat:Infinity, ease:"easeInOut", delay:.3 }}><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.9)" strokeWidth="1.8" strokeLinecap="round"><rect x="3" y="3" width="18" height="18" rx="3"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></motion.div>
                  <div className="text-left">
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '1.15rem', fontWeight: 900, color: '#fff', lineHeight: 1.1 }}>Detector de Estafas</div>
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '.78rem', fontWeight: 600, color: 'rgba(255,255,255,.7)', marginTop: -1 }}>Sacá foto a un mensaje sospechoso</div>
                  </div>
                </div>
            ...
            <motion.button
              ...
              <div className="relative flex items-center justify-between px-6 h-full">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '1.15rem', fontWeight: 900, color: '#fff', lineHeight: 1.1 }}>Test de Blindaje</div>
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '.78rem', fontWeight: 600, color: 'rgba(255,255,255,.8)', marginTop: -1 }}>¿Qué tan protegido estás?</div>
                  </div>
                </div>
          ...
          <div className="relative w-full mb-2.5">
            <motion.button
              ...
              <motion.div className="absolute pointer-events-none"
                ...
                style={{ inset: 0, background: 'linear-gradient(135deg, #c79a00 0%, #ffc844 40%, #ffda6b 70%, #c79a00 100%)', backgroundSize: '200% 200%' }}
              />
              <div className="absolute inset-0 pointer-events-none"
                style={{ background: 'linear-gradient(180deg, rgba(255,255,255,.15) 0%, transparent 55%)' }} />
              <div className="relative flex items-center justify-between px-6 h-full">
                <div className="flex items-center gap-4">
                  <motion.div animate={{ scale:[1,1.18,1] }} transition={{ duration:1.8, repeat:Infinity, ease:"easeInOut", delay:1 }}><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="rgba(16,35,63,.92)" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><path d="M12 14l9-5-9-5-9 5 9 5z"/><path d="M12 14v7"/><path d="M5 11v4c0 1.5 3 3 7 3s7-1.5 7-3v-4"/></svg></motion.div>
                  <div className="text-left">
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '1.15rem', fontWeight: 900, color: '#10233f', lineHeight: 1.1 }}>Aprendé a protegerte</div>
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '.78rem', fontWeight: 700, color: 'rgba(16,35,63,.72)', marginTop: -1 }}>6 temas para reconocer cada engaño</div>
                  </div>
                </div>
                <motion.div animate={{ x: [0, 4, 0] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: .9 }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(16,35,63,.7)" strokeWidth="2.4" strokeLinecap="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                </motion.div>
              </div>
            </motion.button>
          </div>
            ...
            {SITUATIONS.map((s, i) => (
              <motion.button key={i}
                ...
                <motion.div
                  ...
                  style={{ width:44, height:44, borderRadius:13, background:`${s.color}22`, border:`1px solid ${s.color}35`, display:'flex', alignItems:'center', justifyContent:'center', color:s.color, flexShrink:0, marginBottom:8 }}
            ...
            <motion.button whileTap={{ scale: .97 }} onClick={() => setAuxOpen(true)}
              ...
              <div className="relative flex items-center justify-between px-6 h-full">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '1rem', fontWeight: 900, color: '#fff', lineHeight: 1.1 }}>Primeros Auxilios Digitales</div>
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '.78rem', fontWeight: 600, color: '#ef4444', marginTop: -1 }}>Si te estafaron, hacé esto YA →</div>
                  </div>
                </div>
                <motion.div animate={{ x: [0, 4, 0] }} transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut' }}>
      ...
      <AnimatePresence>
        {auxOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center px-5 edf-deskframe"
