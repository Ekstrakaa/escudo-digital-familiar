            ...
            <motion.button
              ...
              <div className="relative flex items-center justify-between px-6 h-full">
                <div className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '1.15rem', fontWeight: 900, color: '#10233f', lineHeight: 1.2 }}>Aprendé a protegerte</div>
                    <div style={{ fontFamily: "'Nunito',sans-serif", fontSize: '.78rem', fontWeight: 700, color: 'rgba(16,35,63,.72)', marginTop: 2 }}>6 temas para reconocer cada engaño</div>
                  </div>
                </div>
