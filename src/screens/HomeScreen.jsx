...
Gratis · Seguro · 24hs · No estás solo.
          ...
          <div className="relative w-full mb-3">
            <motion.button
              ...
              <div className="relative flex items-center justify-between px-6 h-full">
                <div className="flex items-center gap-4">
                  <motion.div animate={{ scale:[1,1.18,1] }} transition={{ duration:1.8, repeat:Infinity, ease:"easeInOut", delay:1 }}><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.9)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 14l9-5-9-5-9 5 9 5z"/><path d="M12 14v7"/><path d="M5 11v4c0 1.5 3 3 7 3s7-1.5 7-3v-4"/></svg></motion.div>
                  <div className="text-left">
