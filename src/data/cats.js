export const CATS = {
  ...
  'El señor del banco 🕴️':{ color:'#ef4444', bg:'rgba(239,68,68,.1)', svg:'<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>', tip:'' },
  'Reconocimiento':{
    color:'#f59e0b',
    bg:'rgba(245,158,11,.1)',
