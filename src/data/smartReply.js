export function getSmartReply(text) {
  ...
  if (/violenc|maltrat|abus|me amenaz|me pegan|me golpe|me grit|me humill|vulnerab|me lastim|me hacen sentir mal|no me respet/.test(t)) {
    return 'Lamento mucho que est\u00e9s pasando por esto. No es tu culpa y lo que sent\u00eds es v\u00e1lido.' + nl + nl + 'No est\u00e1s solo/a. La Intendencia de Montevideo y su Secretar\u00eda de las Personas Mayores est\u00e1n para escucharte y acompa\u00f1arte, con respeto y sin juzgarte.' + nl + nl + 'Comunicate con ellos:' + nl + '\u2022 WhatsApp: 099 019 500 (escrib\u00ed "mayores")' + nl + '\u2022 Tel\u00e9fono: 1950 5555 (L-V 8-19, S\u00e1b 8-14)' + nl + nl + 'Si est\u00e1s en peligro en este momento, llam\u00e1 al 911.' + nl + nl + 'Hablarlo con alguien de confianza tambi\u00e9n ayuda. Dar el primer paso ya es muy valiente.';
  }
